...
const projects = [
  {
    ...
    desc:
      'A full-featured real estate platform built with the MERN stack that enables users to browse, list, and manage property listings. Includes interactive maps, image galleries, advanced search filters, secure JWT-based authentication, and real-time chat powered by Socket.io.',
    img: realEstate,
  ...
  },
  {
    ...
    name: 'ShopVerse',
    desc:
      'A scalable e-commerce backend system built with Spring Boot microservices and Docker, featuring an API Gateway, service registry, Kafka messaging, Redis caching, and Zipkin tracing, paired with a responsive React + TypeScript frontend UI.',
    img: shopVerse,
  ...
  },
  {
    ...
    desc:
      'A real-time chat platform built with Spring Boot and React, enabling users to create chat rooms and exchange messages instantly using WebSocket (STOMP). The system supports scalable communication and a responsive UI powered by Vite and Tailwind CSS.',
    img: chatApp,
  ...
  },
  {
    ...
    desc:
      'An IoT-enabled smart vehicle authentication system using Raspberry Pi and Python that verifies a driver’s license and biometrics before ignition, securely logging each access event to a centralized database.',
    img: driverAuth,
